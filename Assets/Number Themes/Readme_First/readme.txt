In order for this asset to work, you need to import TextMeshPro from the Package Manager.

***How to use:
Check this video: https://youtu.be/IlGU-bMNDuI


Please contact us if you need any help with the asset. yazun.shn@gmail.com
...
**** Please consider leaving a review on the assetstore page (https://assetstore.unity.com/packages/slug/200386). This will greatly help us creating more assets.
**** Thanks for purchasing and good luck on your game.




-Asset Page: https://assetstore.unity.com/packages/slug/200386
